 ...
 *           &lt;element name="ContractedProviderId" type="{http://www.w3.org/2001/XMLSchema}integer" minOccurs="0"/>
 *           &lt;element name="ContractedProviderUniversalId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *           &lt;choice minOccurs="0">
...
@XmlType(name = "", propOrder = {
    ...
    "contractedProviderUniversalId",
    "createdDate",
    "lastActionDate",
    "queryState"
})
@XmlRootElement(name = "productCategoryContractedProviderListFilter")
public class ProductCategoryContractedProviderListFilter {

    protected List<String> legacyId;
    protected List<BigInteger> id;
    @XmlElement(name = "ProductCategoryId")
    protected BigInteger productCategoryId;
    @XmlElement(name = "ProductCategoryUniversalId")
    protected String productCategoryUniversalId;
    @XmlElement(name = "ContractedProviderId")
    protected BigInteger contractedProviderId;
    @XmlElement(name = "ContractedProviderUniversalId")
    protected String contractedProviderUniversalId;
    ...
    /**
     * Gets the value of the contractedProviderId property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getContractedProviderId() {
        return contractedProviderId;
    }

    /**
     * Sets the value of the contractedProviderId property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setContractedProviderId(BigInteger value) {
        this.contractedProviderId = value;
    }

    /**
     * Gets the value of the contractedProviderUniversalId property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getContractedProviderUniversalId() {
        return contractedProviderUniversalId;
    }

    /**
     * Sets the value of the contractedProviderUniversalId property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setContractedProviderUniversalId(String value) {
        this.contractedProviderUniversalId = value;
    }
